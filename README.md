...
The result is a system where identity belongs to the user, encryption is structural (not opt-in), and no single entity controls the registry, the routing, or the keys.
